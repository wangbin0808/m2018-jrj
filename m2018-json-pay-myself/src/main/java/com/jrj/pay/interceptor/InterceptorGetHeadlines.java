...
public class InterceptorGetHeadlines extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		log.info("--InterceptorGetHeadlines请求的路径是"+request.getRequestURL());
		// 若为首页 不进行拦截
		...
		log.info("InterceptorGetHeadlines----开始调用接口："+PayConstant.VERIFY_INTERFACE_URL+"/privilege/getUserPrivilegePeriod?bizCode=5&productId=8&productSubId=100080001&passportId={}",userid);
		...
		log.info("InterceptorGetHeadlines----调用接口："+PayConstant.VERIFY_INTERFACE_URL+"/privilege/getUserPrivilegePeriod?bizCode=5&productId=8&productSubId=100080001&passportId={},用时：{}毫秒",userid,(end-start));
